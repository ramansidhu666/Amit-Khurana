...
namespace Amit_Khurana.Controllers
{
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            model.Latest_News = getdata().Take(2).ToList(); ;
            return View(model);
        ...
        public ActionResult bruise_credit()
        {
            ViewBag.Message = "Your contact page.";
        ...
        public ActionResult debt_consolidation()
        {
            ViewBag.Message = "Your contact page.";

            return View();
        }
        public ActionResult land_transfer()
        {
            ViewBag.Message = "Your contact page.";

            return View();
        }
        public ActionResult lease_programme()
        {
            ViewBag.Message = "Your contact page.";
        ...
        public ActionResult mortgage_rates()
        {
            ViewBag.Message = "Your contact page.";
        ...
        public ActionResult mortgage_loan()
        {
            ViewBag.Message = "Your contact page.";

            return View();
        }
        public ActionResult mortgage_broker()
        {
            ViewBag.Message = "Your contact page.";
        ...
        public ActionResult private_funds()
        {
            ViewBag.Message = "Your contact page.";
        ...
        public string SendEmail(PersonModel model)
        {
            ...
            string Status = "";
            string EmailId = "amit_khurana@centum.ca";
